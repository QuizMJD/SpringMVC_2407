            ...
            <div class="row align-items-center">
                <div class="col py-3">
                    <a class="text-body" href="${pageContext.request.contextPath}/admin">
                        <h3><span class="badge bg-primary">Admin</span> BookShop T3H </h3>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/user-list') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/user-list">
                        <i class="bi bi-people"></i> Quản lý người dùng
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/category-list') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/category-list">
                        <i class="bi bi-tags"></i> Quản lý thể loại
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/product-list') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/product-list">
                        <i class="bi bi-book"></i> Quản lý sản phẩm
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/review-list') ? 'active' : ''}"
                       href="${pageContext.request.contextPath}/admin/review-list">
                        <i class="bi bi-star"></i> Quản lý đánh giá
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${fn:startsWith(servletPath, '/admin/order-list') ? 'active' : ''}"
