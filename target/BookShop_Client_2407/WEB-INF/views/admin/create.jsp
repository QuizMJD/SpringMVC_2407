...
<section class="section-content">
  <div class="container">
    ...
    <main class="add-book-form mb-5">
      <form class="w-50" action="${pageContext.request.contextPath}/admin/product/create" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="add-book-title" class="form-label">Tên sách</label>
          <input type="text" class="form-control" id="add-book-title" name="name" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="add-book-pages" name="pages" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="add-book-publisher" name="publisher" required>
        </div>
        <div class="mb-3">
          <label for="add-book-yearPublishing" class="form-label">Năm phát hành</label>
          <input type="number" class="form-control" id="add-book-yearPublishing" name="yearPublishing" required>
        </div>
        <div class="mb-3">
          <label for="add-book-category" class="form-label">Thể loại</label>
          <select multiple="multiple" class="form-select" id="add-book-category" name="categoryIds" required>
        ...
        <div class="mb-3">
          ...
          <div class="input-group mb-2">
            <input type="text" class="form-control" id="add-book-price" name="price" required>
        ...
        <div class="mb-3">
          ...
          <div class="input-group mb-2">
            <input type="text" class="form-control" id="add-book-discount" name="discount" required>
            <div class="input-group-last">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="add-book-quantity" name="quantity" required>
        </div>
        <div class="mb-3">
          <label for="add-book-description" class="form-label">Mô tả</label>
          <textarea class="form-control" id="add-book-description" name="description" rows="5"></textarea>
        </div>
        <div class="mb-3">
          <label for="add-book-imageName" class="form-label">Hình sản phẩm</label>
          <input type="file" class="form-control" id="add-book-imageName" name="image" accept="image/*">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="date" placeholder="mm/dd/yyyy" class="form-control" id="add-book-startDate" name="startsAt" required>
        </div>
        <div class="mb-3">
          <label for="add-book-endDate" class="form-label">Ngày kết thúc khuyến mãi</label>
          <input type="date" placeholder="mm/dd/yyyy" class="form-control" id="add-book-endDate" name="endsAt" required>
        </div>
