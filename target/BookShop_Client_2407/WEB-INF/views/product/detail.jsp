                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <header class="section-heading py-4 d-flex justify-content-between">
                                        <h3 class="section-title">${product.bookTitle}</h3>
                                    </header>

                                    <div class="row">
                                        <div class="col-md-5">
                                            <!-- Hình ảnh sản phẩm -->
                                            <img src="<c:url value='/resources/images/products/${product.image}'/>"
                                                alt="${product.bookTitle}" class="img-fluid" />
                                        </div>
                                        ...
                                        <div class="col-md-7">
                                            ...
                                            <p><strong>Năm phát hành:</strong> ${product.publicationYear}</p>
                                            <p><strong>Số lượng:</strong> ${product.stockQuantity}</p>
                                    ...
                                    <div class="row">
                                        <c:forEach var="relatedProduct" items="${relatedProducts}">
                                            <div class="col-md-12 mb-4">
                                                <div class="card">
                                                    <img src="<c:url value='/resources/images/products/${relatedProduct.image}'/>"
                                                        class="card-img-top">
                                                    <div class="card-body">
                                                        <h5 class="card-title">${relatedProduct.bookTitle}</h5>
                                                        <p class="card-text">${relatedProduct.price} VND</p>
                                                        <a href="<c:url value='/home/product/${relatedProduct.id}'/>"
