                    ...
                    <section class="section-content mb-2">
                        <div class="container">
                            <header class="section-heading py-4 d-flex justify-content-between">
                                ...
                                <a class="btn btn-secondary" href="#" role="button" style="height: fit-content;">Xem tất
                                    cả</a>
                                                                                                ...
                                                                                                <div class="card mb-4">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <img src="<c:url value='/resources/images/products/default-category.jpg'/>"
                                                                                                                width="50"
                                                                                                                height="50">
                                                                                                            <span
                                                                                                                class="category-title ms-3">${cat.categoryName}</span>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="card p-3 mb-4">
                                            ...
                                            <figcaption class="info-wrap mt-2">
                                                <a href="<c:url value='/home/product/${product.id}'/>"
                                                    class="title">${product.bookTitle}</a>
                                                <div class="price mt-1 fw-bold">${product.price} VND</div>
                                            </figcaption>
                                        </div>
                                    </div> <!-- col.// -->
                                </c:forEach>
